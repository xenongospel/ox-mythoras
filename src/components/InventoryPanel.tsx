...
const INVENTORY_ITEMS: Item[] = [
  ...
  },
  {
    ...
    level: 10,
    attributes: { order: 12, myth: 6 },
    effects: ['Magic Resistance: +15%'],
    value: 1200,
  ...
  },
  {
    ...
    level: 15,
    attributes: { myth: 10, invictus: 5 },
    effects: ['Void Walking: Phase through enemies'],
    value: 2500,
    gridSize: { width: 1, height: 1 }
  },
  
  // Stackable materials (maxStack > 1)
  {
    id: 'crystal-shard',
    name: 'Crystal Shard',
    type: 'material',
    rarity: 'common',
    quantity: 47,
    maxStack: 99, // Materials can stack
    icon: Zap,
    description: 'Crystallized energy used in various crafting recipes.',
    value: 25,
    gridSize: { width: 1, height: 1 }
  },
  {
    ...
    rarity: 'rare',
    quantity: 12,
    maxStack: 50, // Materials can stack
    icon: Star,
    description: 'Pure essence extracted from void creatures.',
    value: 150,
    gridSize: { width: 1, height: 1 }
  },
  {
    ...
    rarity: 'epic',
    quantity: 8,
    maxStack: 25, // Materials can stack
    icon: Package,
    description: 'Concentrated fire energy from the Ember Peaks.',
    value: 300,
    gridSize: { width: 1, height: 1 }
  },
  ...
  // Stackable consumables
  {
    ...
    rarity: 'common',
    quantity: 15,
    maxStack: 20, // Consumables can stack
    icon: Package2,
  ...
  },
  {
    ...
    rarity: 'rare',
    quantity: 8,
    maxStack: 10, // Consumables can stack
    icon: Beaker,
    description: 'Restores magical energy.',
    effects: ['Restore 100 MP', 'Increase mana regen for 5 minutes'],
    value: 120,
    gridSize: { width: 1, height: 1 }
  },
  
  // Currency (highly stackable)
  {
    id: 'gold-coin',
    name: 'Gold Coins',
    type: 'currency',
    rarity: 'common',
    quantity: 2847,
    maxStack: 999999, // Currency stacks very high
    icon: Star,
  ...
  // Key items (usually unique)
  {
    id: 'crystal-key',
    name: 'Crystal Vault Key',
    type: 'key',
    rarity: 'legendary',
    quantity: 1,
    maxStack: 1, // Key items don't stack
    icon: Settings,
    description: 'Unlocks the ancient Crystal Vault in Valdris Reach.',
    gridSize: { width: 1, height: 1 }
  }
];
