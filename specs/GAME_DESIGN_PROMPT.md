...
-> Players will choose their Technician. 
-> Players will choose their starter creature. For now create small 3D models for them. 
-> Creatures have 5 attributes so you will need to build a suitable stat system.
->Player provides email, password and creates their character with a small character creator model. 
-> Player selects their starter creature (Player is called a Technician in this world similar to a Pokemon trainer)
-> Player is taken to a Football manager style dashboard where similar to Runescape, the there is a small context 

Use the following parameters:
-> Full Screen (ThreeJS, GSAP and Framer enabled for cool particle effects, awesome battle animation and potentially real-time movement in a 2.5D isometric game world.
